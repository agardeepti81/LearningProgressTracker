...
var callAPIget = ()=>{
    ...
    // get the progress data of the same subject that is fetched earlier
    initScore = data;
...
var callSubjectAPI = ()=>{
    // get the data from cloud for a specific subject
...
{
    //change the subject state in local objects and variables
